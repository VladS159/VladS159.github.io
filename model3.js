...
// import TWEEN from 'https://cdn.skypack.dev/@tweenjs/tween@latest';

let root, root2, isIndependentMove, originalPosition, originalRotation, newPosition, newRotation, root3, root4, root5, root6, root7, car, car2;
let turning;
...
let velocity = new THREE.Vector3(); // the velocity of the model
...
window.addEventListener('keyup', function(event) {
  switch (event.key) {
    case 'w':
      velocity.z = 0;
      //root.rotation.set(-Math.PI/4, root.rotation.y, root.rotation.z)
      break;
  }
});
